  ...
  module Example
    class Controller < Command::Controller
      ...
      def get_data(message)
        ...
        Message.new(timeframe.current_time, PUT, DATA, message.id, {:headers => dimension_ids, :rows => enum})
      end
      ...
      def get_values(message)
        ...
        Message.new(timeframe.current_time, PUT, VALUES, message.id, {:headers => dimension_ids, :rows => enum})
      end
